...
Gem::Specification.new do |spec|
  ...
  spec.summary       = %q{TODO: A Ruby client library for generating URLs with picfit.}
  spec.description   = %q{TODO: A Ruby client library for generating URLs with picfit.}
